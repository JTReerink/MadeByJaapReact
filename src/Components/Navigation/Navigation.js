    ...
    return(
        <nav className="navigation">
            ...
            <div className="navigation__main">
                <a href="" className="navigation__main--link">Home</a>
                <a href="" className="navigation__main--link">Projecten</a>
                <a href="" className="navigation__main--link">Over</a>
                <a href="" className="navigation__main--link">Blog</a>
                <a href="" className="navigation__main--link">Contact</a>
            </div>
